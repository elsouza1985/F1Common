...
namespace FC1_CC.Common.Services.MicrosoftGraph
{
    ...
    internal class UsersService : IUsersService
    {
        ...
        public async Task<IEnumerable<User>> GetBatchByUserIds(IEnumerable<IEnumerable<string>> userIdsByGroups)
        {
            ...
            var batches = GetBatchRequest(userIdsByGroups);
        ...
        {
            var graphResult = await graphServiceClient
                    .Users
                    .Request()
                    .WithMaxRetry(GraphConstants.MaxRetry)
                    .Filter(filter)
        ...
        public async Task<(IEnumerable<User>, string)> GetAllUsersAsync(string deltaLink = null)
        {
            ...
            {
                collectionPage = await graphServiceClient
                    .Users
                    .Delta()
                    .Request()
            ...
            else
            {
                ...
                collectionPage.InitializeNextPageRequest(graphServiceClient, deltaLink);
        ...
        public async Task<bool> HasTeamsLicenseAsync(string userId)
        {
            ...
            var licenseCollection = await graphServiceClient
                .Users[userId]
                .LicenseDetails
                .Request()
                .Top(GraphConstants.MaxPageSize)
            ...
            if (HasTeamsLicense(licenseCollection))
            {
                return true;
            }
        ...
        private IEnumerable<BatchRequestContent> GetBatchRequest(IEnumerable<IEnumerable<string>> userIdsByGroups)
        {
            ...
            foreach (var userIds in userIdsByGroups)
            {
                ...
                var filterUserIds = GetUserIdFilter(userIds);
