...
namespace FC1_CC.Common.Repositories.NotificationData
{
    ...
    public class NotificationDataEntity : TableEntity
    {
        ...
        {
            get => JsonConvert.DeserializeObject<IEnumerable<string>>(TeamsInString.IsNullOrEmpty() ? "[]" : TeamsInString);
            set => TeamsInString = JsonConvert.SerializeObject(value);
        }
        ...
        {
            get => JsonConvert.DeserializeObject<IEnumerable<string>>(RostersInString.IsNullOrEmpty() ? "[]" : RostersInString);
            set => RostersInString = JsonConvert.SerializeObject(value);
        }
        ...
        {
            get => JsonConvert.DeserializeObject<IEnumerable<string>>(GroupsInString.IsNullOrEmpty() ? "[]" : GroupsInString);
            set => GroupsInString = JsonConvert.SerializeObject(value);
        }
        ...
        /// <summary>
        /// Gets or sets the adaptative card layout.
        /// </summary>
        ...
        public string cardDataInput { get; set; }

        /// <summary>
        /// Gets or sets the recurrence type for the notification.
        /// </summary>
