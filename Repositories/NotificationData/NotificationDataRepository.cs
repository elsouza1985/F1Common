...
namespace FC1_CC.Common.Repositories.NotificationData
{
    ...
    public class NotificationDataRepository : BaseRepository<NotificationDataEntity>, INotificationDataRepository
    {
        ...
        public async Task<IEnumerable<NotificationDataEntity>> GetAllDraftNotificationsAsync()
        {
            ...
            var result = await GetWithFilterAsync(strFilter, NotificationDataTableNames.DraftNotificationsPartition);
        ...
        public async Task<IEnumerable<NotificationDataEntity>> GetAllPendingScheduledNotificationsAsync()
        {
            ...
            var result = await GetWithFilterAsync(filter, NotificationDataTableNames.DraftNotificationsPartition);
        ...
        {
            var result = await GetAllAsync(NotificationDataTableNames.SentNotificationsPartition, 20);

            return result.OrderByDescending(s=>s.SentDate);
        }
        ...
        public async Task<IEnumerable<NotificationDataEntity>> GetMostRecentChannelSentNotificationsAsync(string channelId)
        {
            ...
            var result = await GetWithFilterAsync(strFilter, NotificationDataTableNames.SentNotificationsPartition, 20);
        ...
        public async Task<string> MoveDraftToSentPartitionAsync(NotificationDataEntity draftNotificationEntity)
        {
            try
            {
                ...
                var newSentNotificationId = TableRowKeyGenerator.CreateNewKeyOrderingMostRecentToOldest();
                ...
                var sentNotificationEntity = new NotificationDataEntity
                {
                    ...
                    CardLayout = draftNotificationEntity.CardLayout,
                    cardTemplateType = draftNotificationEntity.cardTemplateType,
                    cardTemplateId = draftNotificationEntity.cardTemplateId,
                    Recurrence = draftNotificationEntity.Recurrence,
                };
                await CreateOrUpdateAsync(sentNotificationEntity);

                // Delete the draft notification.
                if(draftNotificationEntity.Id != null)
                    await DeleteAsync(draftNotificationEntity);
            ...
            string createdBy)
        {
            try
            {
                var newId = TableRowKeyGenerator.CreateNewKeyOrderingOldestToMostRecent();
                ...
                var newNotificationEntity = new NotificationDataEntity
                {
                    ...
                    CardLayout = notificationEntity.CardLayout,
                    cardTemplateId = notificationEntity.cardTemplateId,
                    cardTemplateType = notificationEntity.cardTemplateType,
                };

                await CreateOrUpdateAsync(newNotificationEntity);
            }
            catch (Exception ex)
            {
                Logger.LogError(ex, ex.Message);
        ...
        {
            var notificationDataEntity = await GetAsync(
            ...
            if (notificationDataEntity != null)
            {
                ...
                await CreateOrUpdateAsync(notificationDataEntity);
            }
        }
